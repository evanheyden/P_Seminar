  ...
  create: function () {
    ...
    var nameLabel = game.add.text(200, 150, "Caverunner", {font: "100px Courier", fill: "#fcbc38"});
  ...
  //}
    ...
    //pkey.onDown.addOnce(this.start, this);
     ...
     var playButton = this.game.add.button(450, 300, 'playbutton', this.start, this, 1, 0);
